            ...
            Command::new("cli").about("MAnycastR CLI")
                ...
                .subcommand(Command::new("start").about("performs a hitlist-based measurement")
                    ...
                    .arg(Arg::new("selective")
                        ...
                        .conflicts_with_all(["configuration", "latency", "traceroute", "reverse"])
                    )
                    ...
                    .arg(Arg::new("divide")
                        ...
                        .conflicts_with_all(["latency", "traceroute", "reverse", "unicast"])
                    )
                    .arg(Arg::new("latency")
                        .long("latency")
                        .short('l')
                        ...
                        .conflicts_with_all(["divide", "unicast", "selective", "traceroute", "reverse"])
                    )
                    .arg(Arg::new("responsive")
                        ...
                        .conflicts_with_all(["latency", "divide", "traceroute", "reverse"])
                    )
                    .arg(Arg::new("traceroute")
                        ...
                        .conflicts_with_all(["latency", "responsive", "divide", "unicast", "selective", "reverse", "config"]) // TODO support unicast traceroute
                    )
                    .arg(Arg::new("reverse")
                        .long("reverse")
                        .action(ArgAction::SetTrue)
                        .required(false)
                        .help("Perform a reverse traceroute measurement from the receiving anycast site for each target.")
