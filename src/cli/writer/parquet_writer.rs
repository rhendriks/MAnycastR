...
// use crate::cli::writer::{calculate_rtt, get_header, MetadataArgs, WriteConfig, MAX_ROW_GROUP_SIZE_BYTES, ROW_BUFFER_CAPACITY};
// use crate::custom_module::manycastr::{LatencyReply, Reply, TaskResult};
//
...
// }
//
// pub trait ParquetRowAccessor {
//     // Default implementation returns None, so you only implement what you need
//     fn get_str(&self, _col: &str) -> Option<&str> { None }
//     fn get_i64(&self, _col: &str) -> Option<i64> { None }
//     fn get_i32(&self, _col: &str) -> Option<i32> { None }
//     fn get_f64(&self, _col: &str) -> Option<f64> { None }
// }
//
//
// /// Writes a batch of ParquetDataRow to the Parquet file using the provided writer.
// pub fn write_batch_to_parquet<T: ParquetRowAccessor>(
