    ...
    if let Some(path_str) = path {
        ...
        if !path_str.ends_with('/') {
            ...
            if path.exists() {
                ...
                info!("[CLI] Writing results to new file {path_str}");
            ...
            if path.exists() {
                    ...
                    .readonly()
                {
                    ...
                    info!("[CLI] Writing results to existing directory {path_str}");
                }
            } else {
                info!("[CLI] Writing results to new directory {path_str}");
